...
<!-- Header -->	
<c:if test="${sessionScope.Old_password == null}" >
		<h4 class="card-title mt-3 text-center">You don't have access to this page</h4>
</c:if>
<c:if test="${sessionScope.Old_password != null}">
<!-- Form -->	
	<div class="card bg-light">
		<article class="card-body mx-auto" style="max-width: 400px;">
			...
			<h4 class="card-title mt-3 text-center">Reset Account</h4>
			<h5 class="card-title mt-3 text-center">Enter your information to update password</h5>
			<h5 class="card-title mt-3 text-center">Your old password is: <%=(session.getAttribute("Old_password") == null) ? "": session.getAttribute("Old_password")%></h5>
			<c:remove var="Old_password" scope="session" /> 
