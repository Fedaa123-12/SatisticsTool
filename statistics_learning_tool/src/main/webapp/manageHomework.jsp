...
<tr>
	<th>Topic ID</th>
	<th>Topic Name</th>
	<th>Close Homework</th>
</tr>

<c:forEach items="${getHomework}" var="h">
	<tr>
		<td>${h.homework_title}</td>
		<td>${h.homework_description}</td>
		<td>
			<form action="deleteHomework" method="post">
				<input type="hidden" name = "class_ID" value = "${class_ID}">
				<button class='deleteBtn btn btn-outline-danger' name="close" value="${h.homework_ID}">Close</button>
			</form>
		</td>
	</tr>
</c:forEach>
