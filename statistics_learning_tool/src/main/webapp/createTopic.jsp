...
<!-- Form -->	
	<div class="card bg-light" >
		<article class="card-body mx-auto" style="max-width: 600px;">
			<h4 class="card-title mt-3 text-center">Create Topic</h4>
			<form method = "post" action="addTopic"  >
				...
				<div class="form-group input-group">
					...
					<input  name="topic_name" class="form-control" placeholder="Topic Name"
						type="text">		
				</div>
				<!-- form-group// -->
				<div class="form-group input-group">
					...
					<textarea name="topic_description" class="form-control span6" rows="3" placeholder="Topic Decription" required></textarea>
				</div>
				<!-- form-group// -->
				<div class="form-group input-group">
					<div class="input-group-prepend">
					...
					<input name="topic_media_link" class="form-control" placeholder="Topic Media Link"
						type="text">
				</div>
				<!-- form-group// -->
