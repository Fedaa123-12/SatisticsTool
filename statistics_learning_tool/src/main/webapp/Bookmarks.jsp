...
<div class = "row" id="rows">
	<c:forEach items="${userBookmarks}" var="b">
		<div class='col-lg-4 col-md-6 col-sm-12'>
			<div class= 'postBoxes'>
				<h2><strong><a href="./oneTopicPage?topic_ID=${b.topic_ID}" class="text-info">${b.topic_name}</a></strong></h2>
				<p>${b.topic_description}</p>

				<form action="./deleteBookmark" method="post">
					<input type="hidden" name="user_ID" value="${user_ID}">
					<button class='deleteBtn btn btn-outline-danger' name="bookmark_ID" value="${b.bookmark_ID}">Delete</button>
				</form>
			</div>
		</div>
	</c:forEach>
