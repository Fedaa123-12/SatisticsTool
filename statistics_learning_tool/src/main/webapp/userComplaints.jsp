...
<!-- Form -->	
	<div class="card bg-light">
		<article class="card-body mx-auto" style="max-width: 400px;">
			<h4 class="card-title mt-3 text-center">Submit Complaint</h4>
			<form method = "post" action="./sendComplaint" >
				<!-- form-group// -->
				<div class="form-group input-group">
					...
					<input name="complaint_subject" class="form-control" placeholder="Complaint Subject"
						type="text">
				</div>
				<!-- form-group// -->
				<div class="form-group input-group">
					...
					<textarea name="complaint_description" class="form-control span6" rows="3" placeholder="Complaint Decription" required></textarea>
				</div>
				<!-- form-group// -->
