...
<!-- Form -->	
	<div class="card bg-light">
		<article class="card-body mx-auto" style="max-width: 400px;">
			...
			<form name="form" method = "post" action="register" onsubmit="return CheckPassword(),checkEmptyRegister(),checkRetypePassord()	"  >
				<!-- form-group// -->
				...
				<div class="form-group input-group">
					...
					<input name="username" class="form-control" placeholder="Choose Username"
						type="text">
				</div>
				<!-- form-group// -->
				<div class="form-group input-group">
				...
				<div class="form-group input-group">
					...
					<input name="second_name" class="form-control" placeholder="Second name"
						type="text">
				</div>
				...
				<div class="form-group input-group">
					...
					<input name="DOB" class="form-control" placeholder="Date of birth DD/MM/YYYY"
						type="date">
				</div>
				<!-- form-group end.// -->
				<div class="form-group input-group">
