...
<!-- View a single topic  -->
<h1 class="text-center">${topic.topic_name}</h1>
<p style = "font-size: 35px;"class="text-center">${topic.topic_description}</p>
<div class="embed-responsive embed-responsive-21by9">
<iframe width= "1920" height="1080"
	src="${topic.topic_media_link}">
</iframe> 
</div>
...
<form method = "post" action = ".	/addBookmark">
	<div style="margin-top:10px"class="form-group">
		...
		<button type="submit" class="btn btn-primary btn-block">BookMark</button>
	</div>	
</form>
