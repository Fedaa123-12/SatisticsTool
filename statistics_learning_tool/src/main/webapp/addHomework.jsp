...
<div class="card bg-light">
		<article class="card-body mx-auto" style="max-width: 400px;">
			<h4 class="card-title mt-3 text-center">Set Homework</h4>
			<form method = "post" action="addHomeworkForm" >
				<!-- form-group// -->
				<div class="form-group input-group">
				  ...
				  <select name="topic_ID"  class="form-control" id="sel1" required>
				  		<option selected disabled>Choose the topic name</option>
				...
				<div class="form-group input-group">
					...
					<input name="homework_title" class="form-control" placeholder="Homework Title"
						type="text">
				</div>
				<!-- form-group// -->
				<div class="form-group input-group">
					...
					<input name="homework_description" class="form-control" placeholder="Homework Description"
						type="text">
				</div>
				<!-- form-group// -->
				<div class="form-group">
					<button type="submit" class="btn btn-primary btn-block">Set Homework</button>
				</div>
</form>
</article>
</div>
