...
<c:forEach items="${getUsers}" var="m">
	<tr>
		<td>${m.user_ID}</td>
		<td>${m.email}</td>
		<td>${m.username}</td>
		...
		<td>
			<form action="./updateUsersGetDetails" method="post">
				<button class='updateBtn btn btn-outline-info'  name="update" value="${m.user_ID}">update</button>
			</form>
		</td>
		<td>
			<form action="./deleteUser" method="post">
				<button class='deleteBtn btn btn-outline-danger' name="delete" value="${m.user_ID}">Delete</button>
			</form>
		</td>
	</tr>
</c:forEach>
